...
namespace EternalBAND.Migrations
{
    ...
    [Migration("20240126212218_FK_Messages_Posts_RelatedPostId_Update")]
    partial class FK_Messages_Posts_RelatedPostId_Update
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EternalBAND.DomainObjects.PostTypes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            AddedDate = new DateTime(2024, 1, 26, 22, 22, 18, 156, DateTimeKind.Local).AddTicks(3930),
                        ...
                        new
                        {
                            Id = 2,
                            Active = true,
                            AddedDate = new DateTime(2024, 1, 26, 22, 22, 18, 156, DateTimeKind.Local).AddTicks(3978),
                            Type = "Grup Arıyorum",
                            TypeShort = "Group"
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            AddedDate = new DateTime(2024, 1, 26, 22, 22, 18, 156, DateTimeKind.Local).AddTicks(3981),
