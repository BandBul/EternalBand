...
namespace EternalBAND.Migrations
{
    ...
    [Migration("20240229235656_Changing_PostType_Columns")]
    partial class Changing_PostType_Columns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EternalBAND.DomainObjects.PostTypes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            AddedDate = new DateTime(2024, 3, 1, 0, 56, 56, 466, DateTimeKind.Local).AddTicks(3820),
                        ...
                        new
                        {
                            Id = 2,
                            Active = true,
                            AddedDate = new DateTime(2024, 3, 1, 0, 56, 56, 466, DateTimeKind.Local).AddTicks(3869),
                        ...
                        new
                        {
                            Id = 3,
                            Active = true,
                            AddedDate = new DateTime(2024, 3, 1, 0, 56, 56, 466, DateTimeKind.Local).AddTicks(3874),
